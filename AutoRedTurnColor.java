...
@Autonomous(name = "AutoRedTurnColor", group = "Autonomous Mecanum")
public class AutoRedTurnColor extends LinearOpMode{
    ...
    //s2 is to turn to the left so it will face the crypto box
